...
if ($printedevent == 0) {
        echo '<h2>There are currently no events for this page.</h2>\n<br />Check the <a href="/events/events-calendar/">full calendar</a> for other events that might be of interest to you.';
    }
?>
